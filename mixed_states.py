    ...
    for eta in eta_values:
        ...
        for noise in Kraus_operators.keys():
            ...
            if flags['save_rho_csv']:
                ...
                np.savetxt(plots_path + 'rho_eta=%.2f_alpha=%.2f_im'%(eta, alpha) + '.txt', rho_with_noise, delimiter="\t", fmt='%.4f')
            ...
            if flags['plot_C']:
                for i in C.keys():
                    for j in C[i].keys():
                        pf.plot_matrix_2d(np.real(C[i][j]),
                                          title='$\eta=%.2f$ - $Re$'%eta,
                                          save=flags['save_C'],
                        ...
                        pf.plot_matrix_2d(np.imag(C[i][j]),
                                          title='$\eta=%.2f$ - $Im$'%eta,
                                          save=flags['save_C'],
